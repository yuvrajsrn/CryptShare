...
function settingScreen() {
    ...
    button6.style.display = 'inline-block';
    document.getElementById("statusText").innerHTML = "Settings";
    document.getElementById("subText").innerHTML = "User Management";
}
...
function addUserScreen() {
    ...
    button6.style.display = 'inline-block';
    document.getElementById("statusText").innerHTML = "Settings";
    document.getElementById("subText").innerHTML = "Add user";
}
...
function deleteUserScreen() {
    ...
    button6.style.display = 'inline-block';
    document.getElementById("statusText").innerHTML = "Settings";
    document.getElementById("subText").innerHTML = "Delete user";
}
